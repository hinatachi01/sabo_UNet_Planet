...
# データセットのパス
train_image_dir = '/media/hina/AE60-1503/sabo_UNet_Planet_trial02/04_dataset/01_train/01_images/'
train_mask_dir = '/media/hina/AE60-1503/sabo_UNet_Planet_trial02/04_dataset/01_train/02_masks/'

val_image_dir = '/media/hina/AE60-1503/sabo_UNet_Planet_trial02/04_dataset/02_val/01_images/'
val_mask_dir = '/media/hina/AE60-1503/sabo_UNet_Planet_trial02/04_dataset/02_val/02_masks/'
...
for train_mask_files in glob.glob(train_mask_dir + "*.tif"):
    ...
    msk[msk == 1] = 1 # 崩壊地(1)を(1)に変換 
    msk[msk == 2] = 0  # 非崩壊地(2)を(0)に変換
...
# 崩壊地 (1): 重み2.0、非崩壊地 (0): 重み1.0
weight_map = np.array([5.0, 1.0])
