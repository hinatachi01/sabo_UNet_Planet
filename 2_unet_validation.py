...
# 未学習画像のパス
input_dir = '/media/hina/AE60-1503/sabo_UNet_Planet_trial02/04_dataset/03_test/01_images'
output_dir = '/media/hina/AE60-1503/sabo_UNet_Planet_trial02/predict_masks_2/'
...
for img_path in glob.glob(os.path.join(input_dir, '*.tif')):
    ...
    predicted_mask[collapse_prob < 0.5] = 2  # 非崩壊地
    predicted_mask[collapse_prob >= 0.5] = 1  # 崩壊地
